#!/usr/bin/env python3
"""Extract rustymilk-expr crate from rustymilk-core/src/lib.rs"""

with open("crates/rustymilk-core/src/lib.rs", "r") as f:
    lines = f.readlines()

# RustyMilkValue definition: lines 1301-1326 (1-indexed)
...
# RustyMilkValue (lines 1301-1326)
...
with open("crates/rustymilk-expr/src/lib.rs", "w") as f:
    f.write(final)

print("Extracted expr crate: RustyMilkValue + full expression engine")
