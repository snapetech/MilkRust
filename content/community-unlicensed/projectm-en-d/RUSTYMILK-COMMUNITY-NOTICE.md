# RustyMilk Community Content Notice

Pack: En D Presets

Source: https://github.com/projectM-visualizer/presets-en-d
...
- `MD Episode 2 - out of Da club into da head/intro.mp3`: file type outside the preset/texture/shader import scope.
